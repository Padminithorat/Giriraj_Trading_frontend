...
const Contact = () => {
  return (
    <div className="container-xxl py-5" style={{ backgroundColor: 'lightgrey' }}>
      <div className="container">
        ...
        <div className="row g-4">
          <div className="col-lg-4 col-md-6">
            ...
            <p className="mb-4 text-black">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos</p>
