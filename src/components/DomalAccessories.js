...
// import '../components/DomalAccessories.css';
    ...
    <section id="product" className="block product-block">
      <Container fluid>
        <div className="title-holder">
          <h2>Our product</h2>
          <div className="subtitle">DomalAccessories</div>
        </div>
...
export default DomalAccessories;
