...
// import '../components/SiliconeSealant.css';
    ...
    <section id="product" className="block product-block">
      <Container fluid>
        <div className="title-holder">
          <h2>Our product</h2>
          <div className="subtitle">SiliconeSealant</div>
        </div>
...
export default SiliconeSealant;
