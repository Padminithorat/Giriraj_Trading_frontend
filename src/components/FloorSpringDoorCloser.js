...
// import '../components/FloorSpringDoorCloser.css';
...
function FloorSpringDoorCloser() {
    ...
    <section id="product" className="block product-block">
      <Container fluid>
        <div className="title-holder">
          <h2>Our product</h2>
          <div className="subtitle">FloorSpringDoorCloser</div>
        </div>
...
export default FloorSpringDoorCloser;
