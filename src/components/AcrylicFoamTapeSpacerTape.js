...
// import '../components/AcrylicFoamTapeSpacerTape.css';
...
const productData = [
  {
    ...
    title: 'AcrylicFoamTapeSpacerTape',
    subtitle: 'Web Design'
  },
  {
    id: 2,
...
function AcrylicFoamTapeSpacerTape() {
    ...
    <section id="product" className="block product-block">
      <Container fluid>
        <div className="title-holder">
          <h2>Our product</h2>
          <div className="subtitle">AcrylicFoamTapeSpacerTape</div>
        </div>
...
export default AcrylicFoamTapeSpacerTape;
